...
class _EhnParser:
    ...
    def p_restriction(self, p):
        ...
        p[0] = _node.EhnRestriction(p[2])

    def p_restriction_anchor(self, p):
        '''restriction : SLASH entity anchor'''
        p[0] = _node.EhnRestriction(p[2], anchor=p[3])

    # Anchor
    def p_anchor(self, p):
        '''anchor : ULINE COINDEX'''
        p[0] = _node.EhnAnchor(p[2])
